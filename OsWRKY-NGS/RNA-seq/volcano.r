# 数据示例：
# 	baseMean	log2FoldChange	lfcSE	stat	padj	padj
...
p <- ggplot(
    ...
    theme_bw()+
    theme(
        axis.title.x = element_text(face = "bold", colour = "black", size = 10),  # 修改X轴标签字体大小
        axis.title.y = element_text(face = "bold", colour = "black", size = 10),  # 修改Y轴标签字体大小
